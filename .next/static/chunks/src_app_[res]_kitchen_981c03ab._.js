...
"[project]/src/app/[res]/kitchen/history/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function History() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "History.useEffect": ()=>{
            const fetchOrders = {
                "History.useEffect.fetchOrders": async ()=>{
                    try {
                        ...
                        setOrders(response.data.filter({
                            "History.useEffect.fetchOrders": (order)=>order.isDone
                        }["History.useEffect.fetchOrders"]));
                    } catch (err) {
                        console.log(err);
                    }
                }
...
_s(History, "Tow+PF8xCHECe9sF21HxX7UZkdM=", false, function() {
    return [
...
//# sourceMappingURL=src_app_%5Bres%5D_kitchen_981c03ab._.js.map