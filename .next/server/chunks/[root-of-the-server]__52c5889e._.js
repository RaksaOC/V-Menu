...
async function placeOrder(order) {
    ...
    const existingTableOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$model$2f$TableOrder$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TableOrder"].findOne({
        table: order.table,
        isPayed: false
    });
    if (existingTableOrder) {
        ...
        const newTableOrder = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$model$2f$TableOrder$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TableOrder"]({
            table: order.table,
            orders: [
                savedOrder._id
            ],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52c5889e._.js.map