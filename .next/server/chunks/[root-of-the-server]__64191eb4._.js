...
"[project]/.next-internal/server/app/api/cashier/dashboard/menu/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/cashier/dashboard/menu/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, context) {
    try {
        ...
        console.log(__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connection.name);
        // Access `params` here safely
        const params = await context.params;
        const id = params.id;
        console.log(id);
        console.log("Updating:", id);
        const allItems = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$model$2f$Item$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Item"].find();
        console.log("All Items:", allItems);
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$model$2f$Item$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Item"].findById(id);
        console.log("Found?", existing);
        const body = await req.json();
        const isEnabled = body.isEnabled;
        console.log(isEnabled);
        const updatedItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$model$2f$Item$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Item"].findByIdAndUpdate(id, {
            isEnabled: !isEnabled
        }, {
            new: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__64191eb4._.js.map