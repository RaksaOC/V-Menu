...
export default function Header() {
    ...
    return (
        <div className="header w-full flex bg-gradient-to-r from-slate-800 via-purple-900 to-slate-900 items-center justify-center sticky top-0 right-0 left-0 p-4 z-50 shadow-xl border-b border-purple-500/20">
            <div className="header-wrapper flex justify-between items-center  w-full">
                ...
                <div className="hidden md:flex items-center space-x-4 bg-black/20 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/10">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <Menu as="div" className="relative">
                        <MenuButton className="flex items-center space-x-3 bg-black/20 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/10 hover:bg-black/30 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500">
                        ...
                        <MenuItems className="absolute right-0 mt-3 w-56 origin-top-right rounded-xl bg-white/95 backdrop-blur-md shadow-2xl border border-gray-200 focus:outline-none z-50 overflow-hidden">
                            <div className="py-2">
                                ...
                                <MenuItem>
                                    {({active}) => (
                                        ...
                                        >
                                            <UtensilsCrossed size={16} className="mr-3 text-purple-500" />
                                            Manage Menu
                                        </Link>
                                    )}
                                </MenuItem>
