                ...
                {cards && cards.length > 0 ? (
                    cards.map((card, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`relative bg-white  rounded-2xl border border-slate-500/50 p-6  shadow-md hover:shadow-gray-200/60 transition-all duration-300 hover:-translate-y-1 ${
